          ...
          >
            ...
            <div className="d-flex">
              <a href={myResume} download>
                <span className="rebeccaPurple d-flex justify-content-center p-2 border downloadIcon boxShadow ml-3 pulseHoverOnly">
                  <i
              ...
              <a href={myResume} target={"_blank"} rel="noreferrer">
                <span className="lightGreen d-flex justify-content-center p-2 border viewIcon boxShadow ml-3 pulseHoverOnly">
                  <i
